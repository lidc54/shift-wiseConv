...
void launch_shift_add_forward_v_mp(float *out, const float *input,
...
void launch_shift_add_backward_v_mp(float *gout, float *ginput,
                                const int *pad_hv, const int *idx_identit, const int *idx_out, 
                                int extra_pad, int b, int c_in, int hin, int win,
                                int c_out, int hout, int wout, int group_in);

void add_forward_v_mp(torch::Tensor &out,
                          ...
                          int64_t c_out, int64_t hout, int64_t wout, int64_t group_in)
{
    ...
    launch_shift_add_forward_v_mp((float *)out.data_ptr(),
...
void add_backward_v_mp(torch::Tensor &out,
                          torch::Tensor &input,
                          const torch::Tensor &pad_hv,
                          const torch::Tensor &idx_identit,
                          const torch::Tensor &idx_out,
                          ...
                          int64_t c_out, int64_t hout, int64_t wout, int64_t group_in)
{
    launch_shift_add_backward_v_mp((float *)out.data_ptr(),
