...
# erf1.set_title('ConvNeXt [7, 7, 7, 7]', fontsize=20, y=1.12)
erf1.set_title('RepLKNet [31, 29, 27, 13]', fontsize=20, y=1.12)
...
erf2.set_title('SLaK [51, 49, 47, 13]', fontsize=20, y=1.12)
...
erf3.set_title('SW [51, 49, 47, 13]', fontsize=20, y=1.12)
